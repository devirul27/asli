package hixpro.browserlite.proxy.utils;
...
import hixpro.browserlite.proxy.extensions.ActivityExtensions;
import hixpro.browserlite.proxy.extensions.AlertDialogExtensionsKt;
...
@Singleton
public final class PremiumProxy {

    private static final String TAG = "PremiumProxy";
    ...
    @Inject
    public PremiumProxy(UserPreferences userPreferences,
    ...
    private void initializeProxy(@NonNull Activity activity) {
        ...
        switch (userPreferences.getProxyChoice()) {
            ...
            case MANUAL:
                ...
                host = Config.premiumhost;
                port = Config.pwpremium;
                break;
        }
