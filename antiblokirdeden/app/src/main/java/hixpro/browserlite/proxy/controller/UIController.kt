 ...
 */
package hixpro.browserlite.proxy.controller
...
interface UIController {
     ...
     * closed.
     */
    fun onCloseWindow(tab: GodabiView)
     ...
     */
    fun handleNewTab(newTabType: GodabiDialogBuilder.NewTab, url: String)
