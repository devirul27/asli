...
import hixpro.browserlite.proxy.extensions.drawable
...
/**
 * [GodabiView] acts as a tab for the browser, handling WebView creation and handling logic, as
...
class GodabiView(
    ...
    /**
     * Getter for the [GodabiViewTitle] of the current GodabiView instance.
     *
     * @return a NonNull instance of GodabiViewTitle
     * @return a NonNull instance of GodabiViewTitle
     */
    val titleInfo: GodabiViewTitle
    ...
    @Inject internal lateinit var dialogBuilder: GodabiDialogBuilder
    @Inject internal lateinit var proxyUtils: ProxyUtils
    @Inject internal lateinit var premiumProxy: PremiumProxy

    @Inject @field:DatabaseScheduler internal lateinit var databaseScheduler: Scheduler
    @Inject @field:MainScheduler internal lateinit var mainScheduler: Scheduler
    @Inject lateinit var networkConnectivityModel: NetworkConnectivityModel

    private val godabiWebClient: GodabiWebClient
    ...
    init {
       ...
       godabiWebClient = GodabiWebClient(activity, this)
        ...
        val tab = WebView(activity).also { webView = it }.apply {
            ...
            webChromeClient = GodabiChromeClient(activity, this@GodabiView)
            webViewClient = godabiWebClient

            setDownloadListener(GodabiDownloadListener(activity))
    ...
    fun currentSslState(): SslState = godabiWebClient.sslState

    fun sslStateObservable(): Observable<SslState> = godabiWebClient.sslStateObservable()
    ...
    fun initializePreferences() {
        ...
        godabiWebClient.updatePreferences()
    ...
    /**
     * Initialize the settings of the WebView that are intrinsic to Godabi and cannot be altered
     ...
     * of the current GodabiView and makes the CPU render
     * the view.
     */
     ...
     * of the current GodabiView. The for modes are normal
     ...
     * instance of the GodabiView is useless as
     ...
     */
    private class WebViewHandler(view: GodabiView) : Handler() {

        private val reference: WeakReference<GodabiView> = WeakReference(view)
    ...
    companion object {
        ...
        private const val TAG = "GodabiView"
