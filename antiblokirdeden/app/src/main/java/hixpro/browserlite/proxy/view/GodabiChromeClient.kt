...
import hixpro.browserlite.proxy.favicon.FaviconModel
import hixpro.browserlite.proxy.preference.UserPreferences
import hixpro.browserlite.proxy.view.webrtc.WebRtcPermissionsModel
import hixpro.browserlite.proxy.view.webrtc.WebRtcPermissionsView
...
class GodabiChromeClient(
    ...
    override fun onReceivedIcon(view: WebView, icon: Bitmap) {
        godabiView.titleInfo.setFavicon(icon)
    ...
    override fun onReceivedTitle(view: WebView?, title: String?) {
        if (title?.isNotEmpty() == true) {
            godabiView.titleInfo.setTitle(title)
        } else {
    ...
    override fun onCloseWindow(window: WebView) = uiController.onCloseWindow(godabiView)
    ...
    /**
     * Inflate a view to send to a GodabiView when it needs to display a video and has to
