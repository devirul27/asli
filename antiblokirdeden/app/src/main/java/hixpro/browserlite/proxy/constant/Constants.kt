...
package hixpro.browserlite.proxy.constant
...
const val FILE = "file://"
const val HOME2 = "file:///android_asset/index.html"
...
const val SCHEME_HOMEPAGE = "${ABOUT}homepage"
const val SCHEME_BLANK = "${ABOUT}blank"
const val SCHEME_BOOKMARKS = "${ABOUT}bookmarks"
const val SCHEME_HIXPRO = "${ABOUT}file:///android_asset/index.html"
