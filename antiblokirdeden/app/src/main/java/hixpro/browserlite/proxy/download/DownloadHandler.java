...
import hixpro.browserlite.proxy.constant.Constants;
import hixpro.browserlite.proxy.controller.UIController;
import hixpro.browserlite.proxy.database.downloads.DownloadEntry;
...
import hixpro.browserlite.proxy.utils.Utils;
...
public class DownloadHandler {
    ...
    private void onDownloadStartNoStream(@NonNull final Activity context, @NonNull UserPreferences preferences,
        ...
        GodabiView view = browserActivity.getTabModel().getCurrentTab();
