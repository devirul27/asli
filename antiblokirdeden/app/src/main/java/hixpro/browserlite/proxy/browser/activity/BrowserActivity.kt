...
import kotlinx.android.synthetic.main.newurl.*
import kotlinx.android.synthetic.main.newurl2.*
       ...
       IronSource.init(this, "10adbe32d", IronSource.AD_UNIT.BANNER)
        ...
        IronSource.setRewardedVideoListener(object : RewardedVideoListener{
            ...
            override fun onRewardedVideoAdRewarded(p0: Placement?) {
              val i = Intent(this@BrowserActivity, ProxyMainActivity::class.java)
                startActivity(i)
                finish()
            }
...
//        proxyUtils.updateProxySettings(this)
        ...
        interstitialAd = com.facebook.ads.InterstitialAd(this, "1542826586056888_1542827429390137")
...
//        nativeAd = NativeAd(this, "2670820943207568_2808227436133584")
//        AdSettings.addTestDevice("bba914ed-eb9d-44b0-8b27-c2fd27f28563")
...
//        nativeAdLayout = findViewById<View>(R.id.native_ad_container ) as NativeAdLayout?
//
//        val inflater: LayoutInflater = LayoutInflater.from(this)
//        // Inflate the Ad view.  The layout referenced should be the one you created in the last step.
//        adView = inflater.inflate(R.layout.nativeadsfb, nativeAdLayout, false) as LinearLayout
...
//        val clickableViews: List<View> = ArrayList()
//
...
//        )
    ...
    private fun loadNativeAd2() {
        ...
        // While you are using this temporary code you will only get test ads and if you release
        // your code like this to the Google Play your users will not receive ads (you will get a no fill error).
//        nativeAd = NativeAd(this, "2670820943207568_2808757702747224")
//        AdSettings.addTestDevice("bba914ed-eb9d-44b0-8b27-c2fd27f28563")
//        AdSettings.addTestDevice("0a8bed43-0d8d-4aac-862f-b7c836651927")
//        nativeAd!!.setAdListener(object : NativeAdListener {
//            override fun onAdClicked(p0: Ad?) {
...
//        nativeAd!!.loadAd()
    ...
    private fun inflateAd2(nativeAd: NativeAd) {
//        nativeAd.unregisterView()
//
//        /* Add the Ad view into the ad container. */
//        nativeAdLayout = findViewById<View>(R.id.native_ad_container ) as NativeAdLayout?
...
//        )
    ...
    companion object {
        ...
        fun getStaticContext(): Context? {
            return BrowserApp.getApplication()!!.applicationContext
        }
        @JvmStatic
        var mangolehbalik : String?=null
        // Constant
