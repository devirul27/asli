...
import hixpro.browserlite.proxy.html.download.DownloadPageFactory
...
/**
 * An initializer that is run on a [GodabiView] after it is created.
 */
interface TabInitializer {

    /**
     * Initialize the [WebView] instance held by the [GodabiView]. If a url is loaded, the
