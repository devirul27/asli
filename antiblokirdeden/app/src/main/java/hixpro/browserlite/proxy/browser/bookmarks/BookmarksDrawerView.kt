...
import hixpro.browserlite.proxy.animation.AnimationUtils
import hixpro.browserlite.proxy.browser.BookmarksView
import hixpro.browserlite.proxy.browser.TabsManager
...
import hixpro.browserlite.proxy.di.NetworkScheduler
...
import hixpro.browserlite.proxy.utils.isSpecialUrl
...
class BookmarksDrawerView @JvmOverloads constructor(
    ...
    @Inject internal lateinit var bookmarksDialogBuilder: GodabiDialogBuilder
