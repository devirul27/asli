...
import hixpro.browserlite.proxy.AppTheme
import hixpro.browserlite.proxy.browser.ProxyChoice
import hixpro.browserlite.proxy.browser.SearchBoxDisplayChoice
import hixpro.browserlite.proxy.browser.SearchBoxModel
import hixpro.browserlite.proxy.constant.DEFAULT_ENCODING
import hixpro.browserlite.proxy.device.ScreenSize
import hixpro.browserlite.proxy.di.UserPrefs
import hixpro.browserlite.proxy.preference.delegates.*
import hixpro.browserlite.proxy.search.SearchEngineProvider
import hixpro.browserlite.proxy.search.engine.GoogleSearch
import hixpro.browserlite.proxy.utils.FileUtils
import hixpro.browserlite.proxy.view.RenderingMode
...
class UserPreferences @Inject constructor(
     ...
     * visible.
     */
    var hideStatusBarEnabled by preferences.booleanPreference(HIDE_STATUS_BAR, true)

    /**
     * The URL of the selected homepage.
     */
    var homepage by preferences.stringPreference(HOMEPAGE,"https://yandex.com/")
     ...
     */
    var userAgentChoice by preferences.intPreference(USER_AGENT, 3)

    /**
     * The custom user agent that should be used by the browser.
     */
    var userAgentString by preferences.stringPreference(USER_AGENT_STRING, "Blekok Browser Browser")
     ...
     */
    var proxyPort by preferences.intPreference(USE_PROXY_PORT, 8888)
